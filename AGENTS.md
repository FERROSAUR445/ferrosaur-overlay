# AGENTS.md — ferrosaur-overlay

Ergänzt die Regeln im Dev-Root (`/home/san/dev/ferrosaur/AGENTS.md`). Hier steht
...
```bash
ln -s /home/san/dev/ferrosaur/ferrosaur-overlay/app/node_modules app/node_modules
```
...
const TOKEN_BASE = 'https://api.ferrosaur.de';   // TEMPORÄR: LIVE
