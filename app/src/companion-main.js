// Ferrosaur Companion — zweite, eigenstaendige Electron-App neben dem Overlay.
//
...
app.setName('Ferrosaur Companion Test');

const TOKEN_BASE = 'https://api-test.ferrosaur.de';
// Referenz-Konstante — die tatsächliche Server-Zugehörigkeitsprüfung läuft im Backend.
const DISCORD_GUILD_ID = '1531054994533646536';
const SCHEME = 'ferrosaur-companion-test';
...
function createWindow() {
  win = new BrowserWindow({
    ...
    title: 'Ferrosaur Companion Test',
